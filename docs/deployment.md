...
```properties
SPRING_DATASOURCE_URL=jdbc:mysql://mysql:3306/dev_pro?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai&useSSL=false&allowPublicKeyRetrieval=true
